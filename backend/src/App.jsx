...
export default function App() {
  ...
  // Recalculate live when slider changes if a ZIP code is entered
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px', marginTop: '8px' }}>
          ...
          <h1 style={{ fontSize: '28px', fontWeight: '800', marginTop: '12px', marginBottom: '6px', color: theme.textPrimary }}>
            Property Valuation
          </h1>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <div>
                ...
                <h3 style={{ margin: 0, fontSize: '18px', color: theme.textPrimary }}>{result.city} ({result.matchedZip})</h3>
              </div>
              <span style={{
                background: '#0284c7',
                color: '#ffffff',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div style={{ background: theme.boxBg, padding: '14px', borderRadius: '12px', border: `1px solid ${theme.inputBorder}` }}>
